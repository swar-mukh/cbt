...
echo "Compiling src/workspace/env_parser.cpp" && g++ -std=c++2a -Wall -Wextra -pedantic -c -I ./headers/ src/workspace/env_parser.cpp -o ./build/binaries/workspace/env_parser.o
